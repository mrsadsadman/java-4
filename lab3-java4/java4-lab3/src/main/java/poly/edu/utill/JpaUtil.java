...
public class JpaUtil {
	...
	/**
	 * EntityManagerFactory chịu trách nhiệm quản lý các EntityManager. Nó được khởi
	 * tạo một lần duy nhất.
	 */
	private static EntityManagerFactory factory;

	/**
	 * Phương thức này trả về một EntityManager để thực hiện các thao tác với cơ sở
	 * dữ liệu. * @return EntityManager
	 */
	...
	/**
	 * Phương thức này đóng EntityManagerFactory khi ứng dụng kết thúc để giải phóng
	 * tài nguyên.
	 */
